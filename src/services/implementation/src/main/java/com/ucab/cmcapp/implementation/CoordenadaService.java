...
public class CoordenadaService extends BaseService {
    ...
    @DELETE
    @Path("/delete")
    public Response deleteCoordenadaZonaSeguridad( CoordenadaDto userDto )
    {
        Coordenada entity;
        ...
        try
        {
            entity = CoordenadaMapper.mapDtoToEntity( userDto );
        ...
        _logger.debug( "Leaving CoordenadaService.deleteCoordenada" );
