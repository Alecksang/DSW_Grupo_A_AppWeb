...
import com.ucab.cmcapp.logic.commands.zonasegura.atomic.ModifyZonaSeguraByIdCommand;
import com.ucab.cmcapp.persistence.DBHandler;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class UpdateZonaSeguraCommand extends Command<ZonaSegura>
{
    private static Logger _logger = LoggerFactory.getLogger( UpdateZonaSeguraCommand.class );
    private ZonaSegura _user;
    private ZonaSegura _result;
    private ModifyZonaSeguraByIdCommand _addZonaSeguraCommand;

    public UpdateZonaSeguraCommand(ZonaSegura user )
    {
    ...
    public void execute()
    {
        ...
        try
        {
            ...
            _addZonaSeguraCommand = CommandFactory.createModifyZonaSeguraByIdCommand(_user, getHandler());
